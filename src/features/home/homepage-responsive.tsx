...
function useIsSmall() {
	...
	useEffect(() => {
		const fn = () => setV(window.innerWidth < 420);
		fn();
		window.addEventListener("resize", fn);
		return () => window.removeEventListener("resize", fn);
	}, []);
...
function Problem() {
	...
	const mobile = useIsMobile();
	return (
		<section style={{ padding: mobile ? "48px 20px" : "80px 20px" }}>
			<Divider />
			<div className="mx-auto grid max-w-[1160px] grid-cols-1 items-center gap-[36px] pt-10 md:grid-cols-2 md:gap-[88px] md:pt-20">
				<div>
	...
	return (
		<section
			...
			style={{
				maxWidth: 1160,
				margin: "0 auto",
				padding: mobile ? "0 20px 24px" : "0 20px 40px",
			}}
		>
			<Divider />
			<div
...
function HowItWorks() {
	...
	return (
		<section
			id="how-it-works"
			style={{ padding: mobile ? "48px 20px" : "80px 20px" }}
		>
			<Divider />
			<div
				style={{
	...
	return (
		...
		>
			...
			>
				...
				<div className="mb-[72px] grid grid-cols-1 gap-5 md:grid-cols-3">
					{plans.map((p) => {
...
function CTA() {
	...
	const small = useIsSmall();
	return (
		<section style={{ padding: mobile ? "48px 20px 80px" : "80px 20px 110px" }}>
			<div style={{ maxWidth: 1160, margin: "0 auto" }}>
				<div
					style={{
						...
						border: `1px solid ${T.border}`,
						padding: mobile ? "52px 20px" : "96px 64px",
						textAlign: "center",
					}}
				>
					<div
...
function Footer() {
	...
	return (
		<footer
			style={{
				borderTop: `1px solid ${T.borderSub}`,
				padding: mobile ? "40px 20px 32px" : "52px 20px 44px",
				position: "relative",
				overflow: "hidden",
			}}
		>
			...
			<div style={{ maxWidth: 1160, margin: "0 auto", position: "relative" }}>
				...
				>
					...
					<div
						style={{ display: "flex", gap: mobile ? 28 : 60, flexWrap: "wrap" }}
					>
						{[
							{
								heading: "Product",
